...
// Use script directory for DB_PATH to ensure it's found correctly regardless of how the script is started
...
async function readDB() {
    try {
        ...
        if (error.code === 'ENOENT') {
            ...
            const initialData = { customers: [], payments: [], saasTypes: ["Hora Clínica", "Hora Barber", "Hora Pet"], config: {} };
...
app.get('/api/data', async (req, res) => {
    ...
    console.log(`[${timestamp}] GET /api/data - Request received`);
